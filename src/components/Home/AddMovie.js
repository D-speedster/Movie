...
import BoxInfo from '../Admin/BoxInfo';
import './Home.css'
...
export default function AddMovie() {
    ...
    return (
        <Container className='text-center mt-3'>
            ...
            {/* <input onChange={Change_Handler} type='text' className='m-auto form-control w-50 mt-5' placeholder='Movie Name'></input>
            <button className='btn btn-danger mt-4' onClick={ADD_Handler}>دریافت اطلاعات</button> */}
            <div className='Search_Handler'>
                <button onClick={ADD_Handler}>دریافت اطلاعات</button>

                <input ref={RefCheck} onChange={Change_Handler} type='text' placeholder='آیدی فیلم'></input>
            </div>
            <br />
            <br />
